		  ...
		  <div style="display:none">
		    <div id="inline_content" class="lightBox">
			      ...
			      <c:choose>
			      		...
			      		<c:otherwise>
					      <c:choose>
					      		<c:when test="${mode == 'community'}">
						        	<h4>Select a portion of image above and save it as Community Banner</h4>
					      		</c:when>
					      		<c:otherwise>
						        	<h4>Select a portion of image above and save it as Event Banner</h4>
					      		</c:otherwise>
					      	</c:choose>
