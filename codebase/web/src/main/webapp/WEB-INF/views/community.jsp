                      ...
                      <div id="communityNameBox" class="darkShadeOverlay">
                          <p class="font18">
                            ...
                            <span class="editIconRightAlign">
                              ...
                              <img id="editCommunityName" src="${pageContext.request.contextPath}/static/images/edit-pen-icon-white.png">
                            </span>
                          </p>
                      </div>

                      <div id="communityBanner">
                        <img class="communityBoxPhoto" src="${pageContext.request.contextPath}/static/images/communityPic.jpg">
                    ...
                    <div id="communityDescBlock" class="masonryBox roundedCorners communityWhiteBox" style="margin-bottom:20px;">
                      <div class="pad10 blueHeader14">
                        ...
                        <span class="editIconRightAlign">
                          ...
                          <img id="editCommunityDesc" src="${pageContext.request.contextPath}/static/images/edit-pen-icon-blue.png">
                        </span>
                      </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <span class="cursorPointer blueOnWhite">
                                ...
                                <img id="editCommunityEmail" src="${pageContext.request.contextPath}/static/images/edit-pen-icon-blue.png"/>
                              </span>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>
                              <span class="cursorPointer blueOnWhite">
                                ...
                                <img id="editCommunityContactNum" src="${pageContext.request.contextPath}/static/images/edit-pen-icon-blue.png"/>
                              </span>
                            </td>
                          </tr>
                        </table>
	...
	$(window).load(function() {
      ...
      var dynamicBoxesLoaded = 0;
        ...
        appendMasonryElements(communityFeedsResponseJSONN);
            ...
            $('#anucana_outer_wrapper').on("click", "#flip", function() {
                if(! $("#panel").is(":visible")){
                    ...
                    $( "#member_arrow" ).attr( "src", "${pageContext.request.contextPath}/static/img/up_arrow_grey6.png" );
                    $("#panel").focus();
                }
            });
            ...
            $('#anucana_outer_wrapper').on("blur", "#panel", function() {
                $("#panel").slideUp("fast");
                $( "#member_arrow" ).attr( "src", "${pageContext.request.contextPath}/static/img/down_arrow_grey6.png" );
            });
        ...
        function getMembersAjaxCall(){
          var responseJSON = [
          {"trainer":"Mark","eventName":"Relics of Python","eventDate":"26-Mar-2014", "startTime":"03:30PM","duration":"180 min", "eventVenue":"Hayat Hotel", "imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna blabber on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna blabber on {eventName}" ,  "impIndex":"3", "membershipStatus": "false"},
          {"trainer":"Tony","eventName":"Relics of PHP","eventDate":"22-Apr-2014", "startTime":"05:30PM","duration":"180 min", "eventVenue":"Regals Residency","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna rahul gandhi on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna rahul gandhi on {eventName}" ,  "impIndex":"3", "membershipStatus": "true"},
          ...
          {"trainer":"Brian","eventName":"Relics of Ruby","eventDate":"25-May-2014", "startTime":"01:30PM","duration":"180 min" ,"eventVenue":"Lutyens","imgSrc":"images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna dance on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna dance on {eventName}" ,  "impIndex":"3", "membershipStatus": "false"},
          {"trainer":"Tony","eventName":"Relics of PHP","eventDate":"22-Apr-2014", "startTime":"05:30PM","duration":"180 min", "eventVenue":"Regals Residency","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna rahul gandhi on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna rahul gandhi on {eventName}" ,  "impIndex":"3", "membershipStatus": "true"},
          {"trainer":"Brian","eventName":"Relics of Ruby","eventDate":"25-May-2014", "startTime":"01:30PM","duration":"180 min" ,"eventVenue":"Lutyens","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna dance on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna dance on {eventName}" ,  "impIndex":"3", "membershipStatus": "false"},
          {"trainer":"Brian","eventName":"Relics of Ruby","eventDate":"25-May-2014", "startTime":"01:30PM","duration":"180 min" ,"eventVenue":"Lutyens","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna dance on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna dance on {eventName}" ,  "impIndex":"3", "membershipStatus": "false"},
          {"trainer":"Tony","eventName":"Relics of PHP","eventDate":"22-Apr-2014", "startTime":"05:30PM","duration":"180 min", "eventVenue":"Regals Residency","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna rahul gandhi on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna rahul gandhi on {eventName}" ,  "impIndex":"3", "membershipStatus": "true"},
          {"trainer":"Brian","eventName":"Relics of Ruby","eventDate":"25-May-2014", "startTime":"01:30PM","duration":"180 min" ,"eventVenue":"Lutyens","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna dance on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna dance on {eventName}" ,  "impIndex":"3", "membershipStatus": "false"},
          {"trainer":"Brian","eventName":"Relics of Ruby","eventDate":"25-May-2014", "startTime":"01:30PM","duration":"180 min" ,"eventVenue":"Lutyens","imgSrc":"${pageContext.request.contextPath}/static/images/featured_project.jpg", "shortDesc":"{trainerNameMarkup} is gonna dance on {eventNameMarkup}" , "longDescription":"Its a long desc. {trainerName} is gonna dance on {eventName}" ,  "impIndex":"3", "membershipStatus": "false"}
        ...
        */
        function getMemberBoxElement(index, eventData) {
          ...
          '<div id="dynamicMemberBox'+ index +'" class="memberMasonryBox verticalMargin5 col1">'+
            '<a href="#">'+
              '<img class="communityBoxPhoto" src="${pageContext.request.contextPath}/static/images/memberPic.jpg">'+
            '</a>'+
          '</div>';
