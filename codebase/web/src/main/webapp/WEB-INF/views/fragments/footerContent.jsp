...
<div id="anucana_footer" class="centered">
    ...
    <br/><br/> 
	    copyright © 2014 <a href="${pageContext.request.contextPath}">anucana consulting pvt. ltd.</a> | 
	    designed by <a href="${pageContext.request.contextPath}">anucana designers</a>
    <br/><br/>         
</div>