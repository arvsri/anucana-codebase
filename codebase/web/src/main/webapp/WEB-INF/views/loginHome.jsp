        ...
        <div id="anucana_main">
        	<div id="featured_project_box">
    			<div class="flexslider">
    			  <ul class="slides">
    				<li>
    				<img src="static/images/kitchen_adventurer_cheesecake_brownie.jpg" />
    				</li>
    				<li>
    				<img src="static/images/kitchen_adventurer_lemon.jpg" />
    				</li>
    				<li>
    				<img src="static/images/kitchen_adventurer_donut.jpg" />
    				</li>
    				<li>
    				<img src="static/images/kitchen_adventurer_caramel.jpg" />
    				</li>
    			  </ul>
    			</div>
                ...
                <sf:form action="${pageContext.request.contextPath}/registerNewUser" method="post" modelAttribute="newUserLogin">
	                <table>
	                    <tbody>
	                        ...
	                        <tr>
	                            <td colspan="2"><sf:input path="userId" id="reg_email" placeholder="Email address" /></td>
	                        </tr>
	                        <tr>
