	...
	<script type="text/javascript">
	  ...
	  function appendMasonryElements(responseJSON){
          ...
          $.each(responseJSON, function(i, eventData) {
            var boxElement = getBoxElement(i + lastLoadedCount, eventData.userSubscribed,'${pageContext.request.contextPath}/static/images/featured_project.jpg',eventData.communityId,eventData.about);
