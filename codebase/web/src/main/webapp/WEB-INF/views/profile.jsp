...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/profile-style.css" />
		...
		<div class="first_palate">
			<div class="profile-summary">
				<div class="profile-image">
					<img class="preview-picture" src="${pageContext.request.contextPath}/static/images/arvsri.png" />
					<a class="edit-picture" href="#lightBoxContainer"><img src="${pageContext.request.contextPath}/static/images/camera-icon.png" /></a>
					
					  <div style="display:none" >
							<div id="lightBoxContainer" >
								<div style="float:left; width:30%;">
									<img class='photo' src="${pageContext.request.contextPath}/static/images/arvsri.png" />
								</div>
				...
				<div class="profile-Intro">
					<div class="profile_h1"><a href="javascript:void(0);" id="profile_h1_edit"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a><span>${userProfileInfo.firstName} ${userProfileInfo.lastName}</span></div>
					<div class="profile_h2"><a href="javascript:void(0);" id="profile_h2_edit"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a><span id="updateProfileHeading">${userProfileInfo.profileHeading}</span></div>
					<div class="profile_h3"><a href="javascript:void(0);" id="profile_h3_edit"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a><span id="updateBasicIntro">${userProfileInfo.areaCd}, ${userProfileInfo.countryCd} | ${userProfileInfo.industryCd}</span></iv>
				...
				<div class="contact_details">
					...
					<div class="contact_row">
						<div class="contact_col">
							...
							<div class="contact_h2">
								<a href="javascript:void(0);" id="contact_edit_emailadd"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a>
						...
						<div class="contact_col">
							...
							<div class="contact_h2">
								<a href="javascript:void(0);" id="contact_edit_phone"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a>
					...
					<div class="contact_row">
						<div class="contact_col">
							...
							<div class="contact_h2">
								<a href="javascript:void(0);" id="contact_edit_im"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a>
						...
						<div class="contact_col">
							...
							<div class="contact_h2">
								<a href="javascript:void(0);" id="contact_edit_address"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a>
				...
				<div class="contact_summary"><div class="contact_info_seg"><p>Contact Info</p></div>
					...
					<div class="about_me">
						<div class="about_me_heading">
							...
							<div class="about_me_edit_box"><a href="javascript:void(0);" id="about_me_content_edit"><img src="${pageContext.request.contextPath}/static/images/edit-pen-icon.png" /></a></div>
						</div>
