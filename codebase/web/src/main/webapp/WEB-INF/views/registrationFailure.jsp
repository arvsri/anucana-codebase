	...
	<div id="anucana_wrapper" class="wrapper_1020">
            ...
            <div id="anucana_main" style="height:300px;">
            	<div id="grey_wrapper">
	                ...
	                <h4 style="color:#FF614D"><img src="static/images/icons/login_error_black.png" />&nbsp;&nbsp;Verification Failed !</h4>
	                <p class="description">We regret to say that we are unable to confirm you as a genuine user. Please contact <a href="static/index.html" class="current">anucana help desk</a> for more information.</p>
                    </div>
