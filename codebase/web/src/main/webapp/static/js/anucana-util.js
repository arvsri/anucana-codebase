			...
			'<form action="/web/booking/managed/bookEvent?eventId='+ eventData.eventId +'" method="get">'+
			  '<table style="width:100%; padding:6px;">' +
				'<tr style="padding:5px;">' +
				  '<td width="50%" style="text-align:left;"><div>Number of Seats : <select><option>1</option><option>2</option></<select></div></td>' +
				  '<td><span style="font-weight:bold;">Total</span> : Rs. 825</td>' +
				  '<td><input type="submit" value="Book my seat" id="checkoutButton"  class="blueButton smallButton" tabindex="1" ></td>'
				'</tr>' +
			  '</table>' +
			'</form>'+
			'</div>' +
