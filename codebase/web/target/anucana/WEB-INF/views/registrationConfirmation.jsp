...
<head>
	...
	<title>anucana | registration success</title>
	...
	<div id="anucana_wrapper" class="wrapper_1020">
            ...
            <div id="anucana_main" style="height:300px;">
            	<div id="grey_wrapper">
	                ...
	                <h3>Registration is complete !</h3>
	                <p class="description">We have send a message to your email address. Please check you email and follow the instructions to activate your account.</p>
                    </div>
